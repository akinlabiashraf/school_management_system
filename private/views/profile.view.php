					...
					<div class="row">
						...
						<div class="col-lg-9">
							<div class="page-title d-flex align-items-center justify-content-between">
								...
								<a href="<?=ROOT?>/profile/delete/<?=$row->user_id?>" class="edit-profile-icon"><i class="isax isax-trash"></i></a>

							</div>
							<a href="<?=ROOT?>/profile/edit/<?=$row->user_id?>" class="edit-profile-icon"><i class="isax isax-edit-2"></i></a>
							<?php endif;?>
							<div class="card">
								<div class="card-body">
