            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-12">
                        <h2 class="breadcrumb-title mb-2">Edit Class</h2>
                    ...
                    <div class="row align-items-center row-gap-3">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center flex-wrap gap-3 justify-content-md-end">
                                <a href="add-course.html" class="btn btn-white rounded-pill">Edit Class</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <ul class="settings-nav d-flex align-items-center flex-wrap border bg-light-900 rounded">
                            <li><a href="student-settings.html" class="active">Edit Class</a></li>
                        </ul>
                        <div class="card">
                            <div class="card-body">
                                <?php if ($row): ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Class Name" name="class" value="<?= get_var('school', $row->school ?? '') ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">Class Description <span class="text-danger"> *</span></label>
                                                        <textarea class="form-control" name="class_description" rows="4" placeholder="Class Decription"><?= get_var('school') ?></textarea>
                                                    </div>
                                                </div>
                                                <!-- Cancel Button -->
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <a href="#" class="d-block">
                                                        <button class="btn btn-secondary rounded-pill w-100" type="submit">Update School Data</button>
                                                    </a>
                                                </div>
                                                <!-- if (!$row) {
                                                    # code...
                                ...
                                <?php else: ?>
                                    <H4>No Such Class Exist</H4> <br>
                                    <div class="col-12 col-md-6">
                                        <a href="<?= ROOT ?>classes" class="d-block">
