             ...
             <?php if (isset($test_rows) && $test_rows): ?>
                 ...
                 <?php foreach ($test_rows as $test_row): ?>
                     ...
                     <tr>
                         <td>
                             <?php if (Auth::access('lecturer')): ?>
                                 <!-- <div class="d-flex align-items-center">
                                     <a href="<?= ROOT ?>marked_single/<?= $test_row->test_id ?>/<?= $test_row->user->user_id ?>" class="d-inline-flex fs-14 me-1 action-icon">
                                         <button class="btn btn-sm btn-primary">View<i class="isax isax-arrow-right-1"></i></button>
                                     </a>
                                 </div> -->
                             <?php endif; ?>
                         ...
                         <!-- <td>
                             <h6> <?= get_date($test_row->submitted_date) ?> </h6>
                         </td> -->
                         </td>
                         <td>
                             <?php
                                ...
                                if ($my_marker) {
                                    echo $my_marker->first_name . ' ' . $my_marker->last_name;
                                }
                                ?>
                         </td>
                         </td>
                         <td>
                             <h6> <?= get_date($test_row->marked_date) ?> </h6>
                         </td>
                         <td>
                         ...
                         <td>
                             <?php
                                //  if (can_take_test($test_row->test_id)): 
                                ?>
