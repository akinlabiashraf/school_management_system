            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-12">
                        <h2 class="breadcrumb-title mb-2">Students</h2>
                    ...
                    <div class="row align-items-center row-gap-3">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center flex-wrap gap-3 justify-content-md-end">
                                <a href="<?= ROOT ?>register?mode=students" class="btn btn-white rounded-pill">Add New Student</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="row">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php foreach ($rows as $row): ?>
                                                <?php include(views_path('students')) ?>
                            ...
                            <?php else: ?>
                                <h4>No Students Data Found At The Moment</h4>
                            <?php endif; ?>
