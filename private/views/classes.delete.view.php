            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-12">
                        <h2 class="breadcrumb-title mb-2">Are you sure you wanna deleate this class?!</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <ul class="settings-nav d-flex align-items-center flex-wrap border bg-light-900 rounded">
                            <li><a href="student-settings.html" class="active">Delete class</a></li>
                        </ul>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="#" method="POST">
                                    <div>
                                        <div class="edit-profile-info mb-3">
                                            ...
                                            <p>Delete class from class list</p>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input disabled type="text" class="form-control" placeholder="Class Name" name="class" value="<?= get_var('school', $row[0]->school ?? '') ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea disabled class="form-control" name="class_description" rows="4" placeholder="Class Description"><?= get_var('school', $row[0]->school_description ?? '') ?></textarea>
                                                </div>
                                            </div>
                                            <!-- Cancel Button -->
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6 mb-2 mb-md-0">
                                                    <a href="<?=ROOT?>classes" class="btn btn-primary rounded-pill w-100 d-inline-flex align-items-center justify-content-center fs-14">
                                                ...
                                                <div class="col-12 col-md-6 mb-2 mb-md-0">
                                                    <button
                                                        ...
                                                        data-id="<?= $row[0]->id ?>"
                                                        data-name="<?= htmlspecialchars($row[0]->class ?? '') ?>"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#delete_modal">
                                                        <i class="isax isax-trash me-1"></i> Delete Class
                                                    </button>
                                                </div>
                                            </div>
                                            <!-- <button
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Are you sure you want to delete <strong><span id="classNameDisplay"></span></strong>?
                                                        </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                document.querySelectorAll('[data-bs-target="#delete_modal"]').forEach(function(button) {
                    button.addEventListener('click', function() {
                        ...
                        document.getElementById('classNameDisplay').textContent = name;

                        // Confirm URL
                        const deleteUrl = "<?= ROOT ?>/delete_classes/" + id + "?confirm=yes";
